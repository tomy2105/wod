...
// @version			   2.1
// @author			   Christian
// @contributor    Darkblade, Never, Tomy
// @grant          GM_getValue
// @grant          GM_setValue
// @downloadURL    https://raw.githubusercontent.com/tomy2105/wod/master/wod-discoveries.user.js
// ==/UserScript==
// *************************************************************
...
// *** - fixed, kind of, broken images link ( empty image)   ***
// *************************************************************
      ...
      for (var i=1; i < rows.length; i++)
      {
        ...
        if (anz_icons>0)
        {
          for (j=0; j<anz_icons; j++)
          {
              ...
              if (icon.search(/zustand/) ==-1) icon=undefined;
              else break;
          }
        }
        ...
        if (icon) item.link="<img src="+icon+"> "+item.link;
